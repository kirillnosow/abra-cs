<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="abra.WebForm5" %>
...
<body>
    ...
    <header id="header" class="header">
        ...
        <asp:Label ID="Label1" runat="server" CssClass="forlabel" Width="100%"></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 orderInfo">
                                ...
                                <div class="row" style="padding-top: 5px;">
                                    ...
                                    <div class="col-md-3"></div>
                                    <div class="col-md-3">
                                    <asp:Button ID="Button1" runat="server" class="btn" Text="Войти!" OnClick="Button1_Click" />
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>
        ...
        &nbsp;<a href="/signup.aspx" class="auth-link register-link" data-test="registry_button" style="display: block; margin-left: auto; margin-right: auto; text-align: center;">Нет аккаунта? Зарегистрироваться</a></header>
</body>
</html>